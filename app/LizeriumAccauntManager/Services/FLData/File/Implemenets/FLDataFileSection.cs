...
{
    public class FLDataFileSection
    {
        public string sectionName = "";
        public string directoryINI = "";
        public List<FLDataFileSetting> settings = new List<FLDataFileSetting>();

        /// <summary>
        /// Returns the first value for the specified setting in this section.
        /// </summary>
        /// <param name="settingName">Key name.</param>
        public FLDataFileSetting GetSetting(string settingName)
        {
            foreach (FLDataFileSetting set in this.settings)
