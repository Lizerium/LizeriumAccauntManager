...
namespace Root.Services
{
    ...
    /// </summary>
    public class FLHookSocketService : IFLHookSocketService
    {
        /// <summary>
        /// Если выполнить команду не удалось, то здесь содержится описание ошибки.
        /// </summary>
        ...
        public Dictionary<int, PlayerInfo> PlayerInfoList {  get; set; }

        /// <summary>
        /// Setup a flhook command instance in command and event mode.
        /// </summary>
        public FLHookSocketService()
        {
           PlayerInfoList = new Dictionary<int, FLHookSocketService.PlayerInfo>();
           CheckSettings();
        }
        ...
        /// Request server info from flhook.
        /// </summary>
        /// <returns>True, если успешно, в противном случае false.</returns>
        public bool CmdGetPlayers()
        {
           bool retval = false;
           LastCmdError = "";
        ...
        /// <summary>
        /// Проверьте, находится ли персонаж на сервере.
        /// </summary>
        ...
        private string ReceiveReply(NetworkStream stream, bool unicode)
        {
            ...
            while (true)
            {
                ...
                if (unicode)
                    stReplyBuf += Encoding.Unicode.GetString(rxBuf, 0, rxBytes);
                else
                    stReplyBuf += Encoding.ASCII.GetString(rxBuf, 0, rxBytes);
            }
